...
#ifndef cf3_lss_LIS_hpp
#define cf3_lss_LIS_hpp


#include "LibLSS_LIS.hpp"
...
/**
 * @brief Interface to LIS Library of Iterative Solvers for linear systems.
 * @author Pedro Maciel
 */
class lss_API LIS : public linearsystem< double >
{
  // utility definitions
 ...
 public:
  ...
  static std::string type_name() { return "lis"; }


  /// Construction
  LIS(const std::string& name,
  ...
  LIS& multi(const double& _alpha=1., const double& _beta=0.);

  /// Linear system copy
  LIS& copy(const LIS& _other);
